#!/usr/bin/env python3
"""
Laptop 3 Training Script
Trains: DOGE, DOT models
Total: 4 models
"""
import os
import time
...
def train_laptop3():
    """Train Laptop 3: DOGE, DOT"""
    print("💻 LAPTOP 3 TRAINING")
    print("=" * 40)
    print("Models: DOGE, DOT (4 models total)")
    print()
    
    # Laptop 3 models
    laptop3_tickers = ['DOGE_USDT', 'DOT_USDT']
    timeframes = ['5m', '15m']
    ...
    if not models_to_train:
        print("\n🎉 All Laptop 3 models already exist! Nothing to train.")
        return []
    
    print(f"\nTraining {len(models_to_train)} models on Laptop 3")
    ...
    print("LAPTOP 3 Training Summary:")
...
def main():
    """Main function"""
    print("🤖 ML Trading Bot - Laptop 3 Training")
    print("=" * 50)
    print("This laptop will train: DOGE, DOT")
