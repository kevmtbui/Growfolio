#!/usr/bin/env python3
"""
Laptop 2 Training Script
Trains: XRP, ADA, SOL models
Total: 6 models
"""
import os
import time
...
def train_laptop2():
    """Train Laptop 2: XRP, ADA, SOL"""
    print("💻 LAPTOP 2 TRAINING")
    print("=" * 40)
    print("Models: XRP, ADA, SOL (6 models total)")
    print()
    
    # Laptop 2 models
    laptop2_tickers = ['XRP_USDT', 'ADA_USDT', 'SOL_USDT']
    timeframes = ['5m', '15m']
    ...
    if not models_to_train:
        print("\n🎉 All Laptop 2 models already exist! Nothing to train.")
        return []
    
    print(f"\nTraining {len(models_to_train)} models on Laptop 2")
    ...
    print("LAPTOP 2 Training Summary:")
...
def main():
    """Main function"""
    print("🤖 ML Trading Bot - Laptop 2 Training")
    print("=" * 50)
    print("This laptop will train: XRP, ADA, SOL")
